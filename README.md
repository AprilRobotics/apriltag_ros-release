## apriltag_ros (melodic) - 3.2.1-1

The packages in the `apriltag_ros` repository were released into the `melodic` distro by running `/usr/bin/bloom-release -r melodic apriltag_ros` on `Tue, 05 Apr 2022 15:13:11 -0000`
...
## apriltag_ros (noetic) - 3.2.1-3

The packages in the `apriltag_ros` repository were released into the `noetic` distro by running `/usr/bin/bloom-release -r noetic apriltag_ros` on `Tue, 05 Apr 2022 15:06:56 -0000`
...
## apriltag_ros (noetic) - 3.2.0-1

The packages in the `apriltag_ros` repository were released into the `noetic` distro by running `/usr/bin/bloom-release apriltag_ros -r noetic` on `Thu, 10 Mar 2022 16:22:23 -0000`
...
## apriltag_ros (melodic) - 3.2.0-1

The packages in the `apriltag_ros` repository were released into the `melodic` distro by running `/usr/bin/bloom-release apriltag_ros -r melodic` on `Thu, 10 Mar 2022 16:20:05 -0000`
